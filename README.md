...
Fasciculation (involuntary muscle twitching) is an early biomarker of ALS. This tool supports the manual annotation pipeline for the ALS ultrasound video dataset used in Muti-Scale fasciculation classification.
